...
It is not: take $L=\Sigma^\ast$ and $L'=\mathrm{HP}$ (or any other previously-known undecidable language).
...
\begin{enumerate}
    \item[$(i)$]
    \begin{equation*}
        RU_{110}=\left\{\langle R\rangle\;\middle|\;\begin{aligned}
...
\begin{enumerate}
    ...
    \item[$(iv)$] $L_4=A_{\text{TM}}$ and is not decidable.
\end{enumerate}
...
\begin{questionbox}{$Q8$}
    Is there a decider which can decide whether a given Turing machine $M$:
    \begin{enumerate}
