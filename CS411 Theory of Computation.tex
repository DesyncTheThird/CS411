...
\begin{questionbox}{$Q9$}
    ...
    \begin{enumerate}
        ...
        \item[$(v)$] ever moves the read/write head more than $847$ tape cells away from the left end-marker on \textit{some} input?
        
        \item[$(vi)$] ever moves the read/write head more than $847$ tape cells away from the left end-marker on \textit{all} inputs?
    \end{enumerate}
\end{questionbox}
